...
const PROVIDERS: InsertQuantumProvider[] = [
  { name: "IBM Quantum", hardware: "superconducting", accessModel: "cloud", headquarters: "Armonk, USA", url: "https://www.ibm.com/quantum", category: "hardware", summary: "Superconducting QPUs accessed via Qiskit Runtime on IBM Cloud." },
